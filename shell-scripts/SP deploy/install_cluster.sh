        ...
        upgrade_cluster)
                ...
                #################### Upgrade eBao LifeSystem on Weblogic ##################
                        ...
                        if [  $?  -ne  0 ]; then
                                ...
                                echo ""
                                echo "Weblogic Server is Starting......" |tee -a ${DIR}/${V_LOG}
                        fi
                        echo ""
                       ...
                       # fi
                                echo ""
                                echo ""
                        echo "Please restart batch in one node of cluster manually after the deployment finished."
                                echo ""
                ...
                ;;
	*)
                echo $"Usage: `basename $0` {upgrade_cluster}"
		exit 1;
		;;
esac
